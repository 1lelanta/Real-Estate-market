...
export default function Contact({listing}){
  ...
  return(
    ...
    {landlord &&(
      ...
      <p className='font-semibold'>Contact <span>{landlord.username}</span> 
      for <span className='font-semibold'>{listing.name.toLowerCase()}</span></p>
      <textarea value={message} name='message' id='message' rows="2"
      onChange={onchange} placeholder='message the owner'
